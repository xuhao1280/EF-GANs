...
class Avatar:
    ...
    def __init__(self,dataname):
        # self.data_name = 'C:\\Users\\Administrator\\Desktop\\ww' #输入图片pathC:\Users\Administrator\Desktop\background
        # self.data_name = 'C:/Users/Administrator/Desktop/background/'
...
if __name__ == '__main__':
    ...
    for num in range(len(b)):
        avatar.save_img(b[num], 'H:/GAN-Image/'+os.sep+str(num)+'.jpg')
# import os
# import scipy.misc
# import numpy as np
# from glob import glob
