...
from dcganxuhao.avatar import Avatar
...
class AvatarModel:
    ...
    def train(self):
        ...
        with tf.Session(config=tf.ConfigProto(gpu_options=gpu_options)) as sess:
            ...
            model_path = self.savemodel+ "dcgan.model"
    ...
    def gen(self):
        ...
        for i in range(self.gannumber//self.sample_size if self.gannumber//self.sample_size>0 else 1):
            ...
            with tf.Session() as sess:
                ...
                saver.restore(sess, self.savemodel  + "dcgan.model.ckpt")
            ...
            for num in range(len(samples)):
                # self.avatar.save_img(scipy.misc.imresize(samples[num],[96,192,3]), 'C:\\Users\\Administrator\\Desktop\\ww'+os.sep+'epoch'+str(self.epoch_size)+'-'+str(num+101)+'.jpg')
                self.avatar.save_img(scipy.misc.imresize(samples[num], [96, 192, 3]),
                                     self.ganimage  + 'epoch' + str(
